...
const data = [
  ...
  },
  {
    ...
    bio: [
      "Prior to joining DWHP, Ajay worked as a Private Banking Summer Associate in London for J.P. Morgan where he identified new prospects in the UK hedge fund industry and how to further develop investment strategies with existing clients. Prior to J.P. Morgan, Ajay worked as an Engagement Manager at Oliver Wyman where he designed a restructuring strategy resulting in a savings of $12M, developed a market-entry strategy for a new service offering, and participated in an implementation strategy of a US government mortgage relief program. In 2013, he passed the Level I CFA Exam.",
  ...
  },
  {
    ...
    bio: [
      "Prior to joining DWHP, Josh was an Economic Policy Fellow in the United State Senate, where he focused on Medicare and Medicaid reform. Prior to the Senate, Josh was an analyst in UBS’s Global Healthcare Group, based in London. At UBS, he advised healthcare companies and financial sponsors on mergers and acquisitions, leveraged buyouts, and financings.",
  ...
  },
  {
    ...
    bio: [
      "Erica has five years of research experience working in various areas of psychology. Prior to joining DWHP, she worked as research associate for the National Center for Veteran Studies. Erica’s research, which focused on unit support among Special Operations Forces personnel, was published in the Journal of Special Operations Medicine.",
  ...
  },
  {
    ...
    bio: [
      "Christina has 13 years of administrative experience in private wealth management. Prior to joining DWHP, she worked as an Investment Associate with SunTrust Investment Services, UBS and Smith Barney in Atlanta, Georgia.",
  ...
  },
  {
    ...
    bio: [
      "Monica has ten years of experience in accounting, with seven years dedicated to fund accounting and operations. Prior to DWHP, Monica was the Controller for Peterson Partners, a Salt Lake City-based private equity firm with over $300 million of capital under management. Previously, she was an Investment Operations Senior Associate for Quellos Private Capital Markets, LP in Seattle, WA. In addition, she worked for Ernst &Young LLP in Assurance and Advisory Business Services and for Arthur Andersen LLP in the tax division.",
  ...
  },
  {
    ...
    bio: [
      "Sheila has 18 years of administrative experience. Prior to joining DWHP, she worked as an executive assistant for Clairvest Group Inc. Most notably, Sheila worked as a Personal Assistant to The Hon. Hilary M. Weston after working in various progressive positions over 13 years with George Weston Limited.",
